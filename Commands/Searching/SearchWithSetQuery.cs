...
namespace Commands {
  [Command(6, args = new object[] {"otter", "otter", 1})]
  [Command(7, args = new object[] {"daughter", "ferret", 1})]
  [Command(8, args = new object[] {"wife", "moth", 1})]
  [Command(9, args = new object[] {"lämp", "lämp", 2})]
  [Command(10, args = new object[] {"aunt", "bunny", 1})]
  [Command(11, args = new object[] {"stepdaughter", "crow", 4})]
  [Command(12, args = new object[] {"blender", "blender", 1})]
